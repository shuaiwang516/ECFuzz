...
public class QuorumPeerConfig {
    ...
    private static boolean shouldCollectExercised() {
        String envValue = System.getenv("ECFUZZ_COLLECT_EXERCISED_PARAMS");
        if (envValue == null || envValue.isEmpty()) {
            envValue = System.getProperty("ecfuzz.collect.exercised.params", "false");
        }
        ...
        for (Entry<Object, Object> entry : zkProp.entrySet()) {
            ...
            if (key.equals("dataDir") && inj_env_param) {
                ...
                if (value.toLowerCase().equals("true")) {
                    setStandaloneEnabledSilently(true);
                } else if (value.toLowerCase().equals("false")) {
                    setStandaloneEnabledSilently(false);
                } else {
                    throw new ConfigException("Invalid option " + value + " for standalone mode. Choose 'true' or 'false.'");
                }
            } else if (key.equals("reconfigEnabled")) {
                if (value.toLowerCase().equals("true")) {
                    setReconfigEnabledSilently(true);
                } else if (value.toLowerCase().equals("false")) {
                    setReconfigEnabledSilently(false);
                } else {
    ...
    public InetSocketAddress getClientPortAddress() { logAccess("clientPortAddress"); return clientPortAddress; }
    public InetSocketAddress getSecureClientPortAddress() { logAccess("secureClientPortAddress"); return secureClientPortAddress; }
    public File getDataDir() { logAccess("dataDir"); return dataDir; }
    public File getDataLogDir() { logAccess("dataLogDir"); return dataLogDir; }
    public int getTickTime() { logAccess("tickTime"); return tickTime; }
    public int getMaxClientCnxns() { logAccess("maxClientCnxns"); return maxClientCnxns; }
    public int getMinSessionTimeout() { logAccess("minSessionTimeout"); return minSessionTimeout; }
    public int getMaxSessionTimeout() { logAccess("maxSessionTimeout"); return maxSessionTimeout; }
    public boolean areLocalSessionsEnabled() { logAccess("localSessionsEnabled"); return localSessionsEnabled; }
    public boolean isLocalSessionsUpgradingEnabled() {
        logAccess("localSessionsUpgradingEnabled");
    ...
    public boolean shouldUsePortUnification() {
        logAccess("portUnification");
        return shouldUsePortUnification;
    }

    public int getInitLimit() { logAccess("initLimit"); return initLimit; }
    public int getSyncLimit() { logAccess("syncLimit"); return syncLimit; }
    public int getElectionAlg() { logAccess("electionAlg"); return electionAlg; }
    public int getElectionPort() { return electionPort; }

    public int getSnapRetainCount() {
        logAccess("autopurge.snapRetainCount");
        return snapRetainCount;
    }

    public int getPurgeInterval() {
        logAccess("autopurge.purgeInterval");
        return purgeInterval;
    }
    
    public boolean getSyncEnabled() {
        logAccess("syncEnabled");
        return syncEnabled;
    }
    ...
    public Boolean getQuorumListenOnAllIPs() {
        logAccess("quorumListenOnAllIPs");
    ...
    public static void setStandaloneEnabledSilently(boolean enabled) {
        standaloneEnabled = enabled;
    }
    ...
    public static void setReconfigEnabledSilently(boolean enabled) {
        reconfigEnabled = enabled;
    }
