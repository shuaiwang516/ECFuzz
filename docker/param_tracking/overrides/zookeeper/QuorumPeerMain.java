...
public class QuorumPeerMain {
            ...
            throws IOException, AdminServerException
    {
      ...
      try {
          ...
          logAccess("sslQuorumReloadCertFiles");
          ...
          logAccess("quorum.auth.enableSasl");
          if(quorumPeer.isQuorumSaslAuthEnabled()){
              quorumPeer.setQuorumServerSaslRequired(config.quorumServerRequireSasl);
              logAccess("quorum.auth.serverRequireSasl");
              quorumPeer.setQuorumLearnerSaslRequired(config.quorumLearnerRequireSasl);
              logAccess("quorum.auth.learnerRequireSasl");
              quorumPeer.setQuorumServicePrincipal(config.quorumServicePrincipal);
              logAccess("quorum.auth.kerberos.servicePrincipal");
              quorumPeer.setQuorumServerLoginContext(config.quorumServerLoginContext);
              logAccess("quorum.auth.server.saslLoginContext");
              quorumPeer.setQuorumLearnerLoginContext(config.quorumLearnerLoginContext);
              logAccess("quorum.auth.learner.saslLoginContext");
          }
          quorumPeer.setQuorumCnxnThreadsSize(config.quorumCnxnThreadsSize);
          logAccess("quorum.cnxn.threads.size");
